...
export const AuthProvider = ({ children }) => {
  ...
  const signup = async (postData) => {
    try {
      const response = await axios.post(
        "https://k618de24a93cca.user-app.krampoline.com/api/signup",
        postData,
        {
  ...
  const login = async (userData, navigateCallback) => {
    setIsLoading(true);
    try {
      const response = postLogin(userData);
  ...
  const logout = async (navigate) => {
    ...
    try {
      await axios.post(
        "https://k618de24a93cca.user-app.krampoline.com/api/logout",
        {},
        { withCredentials: true }
      );
  ...
  const loadUserInfo = async () => {
    ...
    try {
      const response = await axios.get(
        "https://k618de24a93cca.user-app.krampoline.com/api/myinfo",
        {
  ...
  const fetchAllUsers = async () => {
    try {
      const response = await axios.get(
        "https://k618de24a93cca.user-app.krampoline.com/api/admin/all",
        {
          withCredentials: true,
        }
      );
  ...
  const fetchCount = async () => {
    try {
      const response = await axios.get(
        "https://k618de24a93cca.user-app.krampoline.com/api/admin/totalUsers",
        {
          withCredentials: true,
        }
      );
